...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`historico_reproducao` (
  ...
  CONSTRAINT `fk_historico_reproducao_usuario`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_historico_reproducao_cancao`
    FOREIGN KEY (`idcancoes`)
...
VALUES
	...
	("Dance With Her Own", 116, '1990/01/01', 1, 1),
	("Troubles Of My Inner Fire", 203, '1993/01/01', 1, 2),
	("Time Fireworks", 152, '1993/01/01', 1, 2),
	("Magic Circus", 105, '1995/01/01', 2, 3),
	("Honey, So Do I", 207, '1995/01/01', 2, 3),
	("Sweetie, Let's Go Wild", 139, '1995/01/01', 2, 3),
	("She Knows", 244, '1995/01/01', 2, 3),
	("Fantasy For Me", 100, '1998/01/01', 3, 4),
	("Celebration Of More", 146, '1998/01/01', 3, 4),
	("Rock His Everything", 223, '1998/01/01', 3, 4),
	("Home Forever", 231, '1998/01/01', 3, 4),
	("Diamond Power", 241, '1998/01/01', 3, 4),
	("Let's Be Silly", 132, '1998/01/01', 3, 4),
	("Thang Of Thunder", 240, '2001/01/01', 4, 5),
	("Words Of Her Life", 185, '2001/01/01', 4, 5),
	("Without My Streets", 176, '2001/01/01', 4, 5),
	("Need Of The Evening", 190, '2003/01/01', 4, 6),
	("History Of My Roses", 222, '2003/01/01', 4, 6),
	("Without My Love", 111, '2003/01/01', 4, 6),
	("Walking And Game", 123, '2003/01/01', 4, 6),
	("Young And Father", 197, '2003/01/01', 4, 6),
	("Finding My Traditions", 179, '2007/01/01', 5, 7),
	("Walking And Man", 229, '2007/01/01', 5, 7),
	("Hard And Time", 135, '2007/01/01', 5, 7),
	("Honey, I'm A Lone Wolf", 150, '2007/01/01', 5, 7),
	("She Thinks I Won't Stay Tonight", 166, '2012/01/01', 5, 8),
	("He Heard You're Bad For Me", 154, '2012/01/01', 5, 8),
	("He Hopes We Can't Stay", 210, '2012/01/01', 5, 8),
	("I Know I Know", 117, '2012/01/01', 5, 8),
	("He's Walking Away", 159, '2015/01/01', 5, 9),
	("He's Trouble", 138, '2015/01/01', 5, 9),
	("I Heard I Want To Bo Alone", 120, '2015/01/01', 5, 9),
	("I Ride Alone", 151, '2015/01/01', 5, 9),
	("Honey", 79, '2015/01/01', 6, 10),
	("You Cheated On Me", 95, '2015/01/01', 6, 10),
	("Wouldn't It Be Nice", 213, '2015/01/01', 6, 10),
